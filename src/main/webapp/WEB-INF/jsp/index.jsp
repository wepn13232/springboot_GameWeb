            ...
            <div class="header-right wthree">
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-left cl-effect-14">
                        <li><a href="${pageContext.request.contextPath}/index" class="active">主页</a></li>
...
<div class="welcome">
    <div class="container">
        ...
        <div class="col-md-6 welcome-w3lleft">
            <h3 class="agileits-title">都不用慌 !</h3>
            <h4>在本网站，我们将提供最安全的游戏购买渠道、最全的游戏资讯、最完美的游戏售后！ </h4>
            <p>Don't be panic ! We'll give you the most safty way to buy the game you like ! Also we'll provide the best after-sale service for you!
            </p>
        </div>
...
<div class="features">
    <div class="container">
        <div class="w3ls-title">
            <h3 class="agileits-title">在这你可以了解到</h3>
        </div>
